<script>
  ...
  const SEVERITY_COLORS = {
    critical: { color: "#FF1744", emissive: "#FF1744", ring: "#FF5252", pulse: "#FF8A80" },
    high:     { color: "#FF6D00", emissive: "#FF6D00", ring: "#FF9100", pulse: "#FFAB40" },
    medium:   { color: "#FFD600", emissive: "#FFD600", ring: "#FFEA00", pulse: "#FFFF00" },
    low:      { color: "#00E5FF", emissive: "#00E5FF", ring: "#18FFFF", pulse: "#84FFFF" },
  };
  ...
  function handleClick() {
    ...
    dispatch('pinclick', { id: pinId, label, severity, traumaType, description, bodyRegion });
  }
    ...
    {#if showDetails}
      <HTML position={[0, 0.28, 0]} pointerEvents="auto" center>
        <div class="pin-detail-card">
          <!-- Close button -->
          <button class="pin-close-btn" on:click|stopPropagation={() => showDetails = false}>✕</button>
