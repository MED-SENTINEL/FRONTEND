    ...
    <button 
      ...
      class="px-3 py-2 rounded-lg border text-[9px] font-bold uppercase transition-all
        {confirmDelete 
          ...
          : 'border-slate-200 text-sentinel-dim hover:text-sentinel-critical hover:border-sentinel-critical/30 hover:bg-sentinel-critical/5 opacity-0 group-hover:opacity-100 scale-95 group-hover:scale-100'}
        disabled:opacity-50"
    >
      {#if deleting}
        Deleting...
